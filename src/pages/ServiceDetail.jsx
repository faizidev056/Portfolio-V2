    ...
    return (
        <div className="pt-24 pb-16 min-h-screen bg-gray-50 flex items-center justify-center">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h1 className="text-4xl font-bold text-gray-900 mb-6">Service Detail: {id}</h1>
                <p className="text-xl text-gray-600 mb-8">
                    This is a placeholder page for the {id} service. Detailed information about this service will be populated here soon.
                </p>
