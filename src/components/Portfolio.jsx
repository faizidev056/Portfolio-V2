      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 lg:mb-20">
          <div className="flex justify-center mb-6">
            <div className="bg-blue-600 text-white px-6 py-2 rounded-full text-sm font-semibold tracking-wide uppercase shadow-lg">
              Portfolio Showcase
            </div>
          </div>
        ...
        <div id="reviews" className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 xl:p-16 shadow-xl border border-gray-100 mb-12 sm:mb-16">
          <div className="text-center mb-8 sm:mb-12">
            <h3 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">
              What Clients
              <span className="block sm:inline text-blue-600"> Say</span>
            </h3>
          ...
          <div className="relative max-w-sm sm:max-w-4xl lg:max-w-6xl mx-auto">
              ...
              >
                {testimonials.map((testimonial, index) => (
                  <div key={index} className="w-full flex-shrink-0 px-2 sm:px-4 lg:px-6">
                    <div className="bg-gray-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-12 border border-gray-100 shadow-lg max-w-sm sm:max-w-2xl lg:max-w-4xl mx-auto">
                      {/* Quote Icon */}
                      <div className="flex justify-center mb-6 sm:mb-8">
                        <div className="w-16 h-16 sm:w-18 sm:h-18 lg:w-20 lg:h-20 bg-blue-400 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg transform -rotate-12">
            ...
            {/* Progress Bar */}
            <div className="w-full bg-gray-100 rounded-full h-2 sm:h-3 mt-6 sm:mt-8 overflow-hidden shadow-inner relative mx-4 sm:mx-0">
              {/* Background glow effect */}
              <div className="absolute inset-0 bg-blue-50 rounded-full opacity-50"></div>

              {/* Main progress bar */}
              <div
                className="bg-blue-500 h-full rounded-full transition-all duration-700 ease-out shadow-lg relative overflow-hidden"
                style={{ width: `${((currentTestimonial + 1) / testimonials.length) * 100}%` }}
              >
                {/* Animated shimmer effect */}
                <div className="absolute inset-0 bg-white opacity-30 -skew-x-12 animate-shimmer"></div>

                {/* Inner highlight */}
                <div className="absolute top-0 left-0 right-0 h-0.5 sm:h-1 bg-blue-300 rounded-full opacity-60"></div>
              </div>
